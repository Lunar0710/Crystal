...
public final class PostEffects {
    ...
    public static final Identifier COLOR_GRADE = Identifier.fromNamespaceAndPath(CrystalClient.MOD_ID, "color_grade");
    public static final Identifier MOTION_BLUR = Identifier.fromNamespaceAndPath(CrystalClient.MOD_ID, "motion_blur");
    public static final Identifier BOTH = Identifier.fromNamespaceAndPath(CrystalClient.MOD_ID, "color_grade_motion_blur");
    ...
    private static void tick(Minecraft mc) {
        ...
        if (wanted == null) {
            if (currentIsOurs) mc.gameRenderer.clearPostEffect();
